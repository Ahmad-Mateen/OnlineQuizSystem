...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar fixed-top">
        <div class="container sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap">
            ...
            <a class="inline-block mr-4 py-0.5 text-xl whitespace-nowrap hover:no-underline focus:no-underline"
                href="index.html">
                <img src="frontend/assets/images/logo.svg" alt="alternative" class="h-8" />
            </a>
            ...
            <div class="navbar-collapse offcanvas-collapse lg:flex lg:flex-grow lg:items-center"
                ...
                <ul class="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                    <li>
                        <a class="nav-link page-scroll active" href="#header">Dashboard <span
                    ...
                    <li>
                        <a class="nav-link page-scroll" href="{{ route('loginPageView') }}">Login</a>
                    </li>
                </ul>
    ...
    <header id="header" class="header py-28 text-center md:pt-36 lg:text-left xl:pt-44 xl:pb-32">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
            <div class="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
                ...
                {{-- <a class="btn-solid-lg secondary" href="#your-link"><i class="fab fa-google-play"></i></a> --}}
            </div>
            <div class="xl:text-right">
                <img class="inline" src="frontend/assets/images/header-smartphone.png" alt="alternative" />
            </div>
        </div> <!-- end of container -->
        ...
        <div class="container px-4 sm:px-8 xl:px-4">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="frontend/assets/images/features-icon-1.svg" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="frontend/assets/images/features-icon-2.svg" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="frontend/assets/images/features-icon-3.svg" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="frontend/assets/images/features-icon-4.svg" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="frontend/assets/images/features-icon-5.svg" alt="alternative" />
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-image">
                    <img src="frontend/assets/images/features-icon-6.svg" alt="alternative" />
                </div>
                <div class="card-body">
    ...
    <div id="details" class="pt-12 pb-16 lg:pt-16">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            ...
            <div class="lg:col-span-7">
                <div class="xl:ml-14">
                    <img class="inline" src="frontend/assets/images/details-1.jpg" alt="alternative" />
                </div>
            </div> <!-- end of col -->
        </div> <!-- end of container -->
    </div>
        ...
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            <div class="lg:col-span-7">
                <div class="mb-12 lg:mb-0 xl:mr-14">
                    <img class="inline" src="frontend/assets/images/details-2.jpg" alt="alternative" />
                </div>
            </div> <!-- end of col -->
            <div class="lg:col-span-5">
                <div class="xl:mt-12">
        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-x-8">
            ...
            <div class="lg:col-span-8">
                <div class="mb-12 text-center lg:mb-0 lg:text-left xl:mr-6">
                    <img class="inline rounded-lg" src="frontend/assets/images/details-lightbox.jpg" alt="alternative" />
                </div>
            </div> <!-- end of col -->
    ...
    <div class="pt-16 pb-12">
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            ...
            <div class="lg:col-span-7">
                <div class="ml-14">
                    <img class="inline" src="frontend/assets/images/details-3.jpg" alt="alternative" />
                </div>
            </div> <!-- end of col -->
        </div> <!-- end of container -->
    </div>
                ...
                <div class="swiper-container card-slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="frontend/assets/images/testimonial-1.jpg" alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="frontend/assets/images/testimonial-2.jpg" alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="frontend/assets/images/testimonial-3.jpg" alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="frontend/assets/images/testimonial-4.jpg" alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="frontend/assets/images/testimonial-5.jpg" alt="alternative" />
                                <div class="card-body">
                        ...
                        <div class="swiper-slide">
                            <div class="card">
                                <img class="card-image" src="frontend/assets/images/testimonial-6.jpg" alt="alternative" />
                                <div class="card-body">
    ...
    <div class="footer">
        <div class="container px-4 sm:px-8">
            <h4 class="mb-8 lg:max-w-3xl lg:mx-auto">Online Quiz System is a exam taken online website and you can
                reach the team at <a class="text-indigo-600 hover:text-gray-500"
                    href="ahmadmateen786@gmail.com">ahmadmateen786@gmail.com</a></h4>
    ...
    <!-- Scripts -->
    <script src="frontend/assets/js/jquery.min.js"></script> <!-- jQuery for JavaScript plugins -->
    <script src="frontend/assets/js/jquery.easing.min.js"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="frontend/assets/js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
    <script src="frontend/assets/js/jquery.magnific-popup.js"></script> <!-- Magnific Popup for lightboxes -->
    <script src="frontend/assets/js/scripts.js"></script> <!-- Custom scripts -->
</body>
