...
<body class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            ...
                            <div class="card card-plain mt-8">
                                ...
                                <div class="alert alert-info .text-white alert-dismissible d-flex align-items-center">
                                    <i class="bi-info-circle-fill .bg-light"></i>
                                    <strong class="mx-2 text-white">Info!</strong> <span class="text-white">{{Session::get('message')}}</span>
                                    <button type="button" id="cross" style="padding: 15px 20px; color: white; opacity: 1;" class="btn-close  " data-bs-dismiss="alert"></button>
                                </div>
                                @endif
                                    ...
                                    <form action="{{ route('login') }}" method="POST">
                                      @csrf
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input focus:border-[#21D4FD]" type="checkbox"
    ...
    <script>
        document.querySelector('#cross').insertAdjacentHTML("beforeend",'X');
    </script>
